...
What I learned?
How a real game loop works, how to handle click events, how to draw UI elements on screen, and how to structure a project using functions. Also learned how to convert it into an actual .exe file so anyone can run it without installing Python 🔥
